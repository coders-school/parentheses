...
TEST(ParenthesesTests, givenCurlyBracketsAndSquaredBracketsInRoundBrackets_WhenIsBalancedIsCalled_ThenResultIsTrue)
{
    // GIVEN
    std::string input = "{}([])";
    Parentheses p;
...
TEST(ParenthesesTests, givenParenthesisEnclosedInCurlyBracketsAndCurlyBracketsEnclosedInPairOfSqureBrackets_WhenIsBalancedIsCalled_ThenResultIsTrue)
{
    // GIVEN
    std::string input = "{()}[[{}]]";
    Parentheses p;
...
TEST(ParenthesesTests, givenTextEnclosedInRoundSquaredCurlyBrackets_WhenIsBalancedIsCalled_ThenResultIsTrue)
{
    // GIVEN
